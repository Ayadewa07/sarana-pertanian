...
// Fallback: Central product database array with pricing and updated categories
$products = [
    1 => [
        'id' => 1,
    ...
    7 => [
        'id' => 7,
        'name' => 'Kargo Distribusi B2B',
        'category' => 'logistik',
        'sub_category' => 'Kargo & Distribusi',
        'price' => 1200000,
        'description' => 'Layanan pengiriman kargo curah, pupuk, dan hasil panen dengan armada terlindungi.',
        'full_description' => 'Sarana Pertanian menyediakan layanan armada distribusi logistik khusus sektor agribisnis. Kami melayani transportasi pupuk volume besar, benih perkebunan, serta pengangkutan hasil panen dari lahan ke gudang penyimpanan utama dengan armada prima dan terpantau.',
        'image' => 'gambar/image_from_https_images.unsplash.com_photo_1690292885661_3818e5fe9067_auto/screen.png',
        'badge' => 'Logistik',
        'tag' => 'Logistik',
        'crop_target' => 'Semua Wilayah Operasi Jawa-Bali',
        'dosage' => 'Hubungi Kontak B2B untuk Penjadwalan Armada',
        'benefits' => [
            'Distribusi produk pupuk dan benih yang aman & kering',
            'Armada truk prima terpantau GPS secara real-time',
            'Kapasitas kargo box besar hingga 8 ton',
            'Ketepatan waktu pengiriman terjamin'
        ]
    ]
];
